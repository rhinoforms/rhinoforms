...
public class TransformHelper {
	...
	public String handleTransform(String transformXsl, boolean omitXmlDeclaration, Map<String, String> xsltParameters, Document dataDocument, String message) throws TransformHelperException{
